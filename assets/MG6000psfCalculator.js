...
var psf_69d4_69d4_M1_J1 = "=   +69.9 /  -69.9 PSF  M1 / J1";
...
var psf_100_110_M3_M2   = "=  +100.0 / -110.0 PSF  M3 / J2";
...
var NotCompliant = NotCompliant;
    ...
    {                                                            // &   Width:  30", 36", 42", 48", 54" 60" 63"             M3 / J2
        ...
        else if (width <= 63) { psfResult = psf_100_102d4   + "<br/> " + psf_100_115_M3_J2_RCS ;}
        ...
        else if (width <= 54) { psfResult = psf_65_65_M1_J1     + "<br/> " + psf_100_103d9_M3_J2;
                                psfResult +=                      "<br/> " + psf_100_115_M3_J2_RCS;}
        else if (width <= 58) { psfResult = psf_65_65_M2_J2     + "<br/> = + 95.1 / -95.1 PSF  M3 / J2 *Reinforced";
                                psfResult +=                      "<br/> " + psf_100_115_M3_J2_RCS;}
